 ...
 */
export type DomainEventType = 'SessionCreated' | 'ParticipantInvited' | 'SessionStarted' | 'ResponseRecorded' | 'PageCompleted' | 'SessionCompleted' | 'SessionExpired' | 'SessionSuspended' | 'ParticipantCreated' | 'ParticipantProfileUpdated' | 'ParticipantSessionAssigned' | 'ParticipantDeactivated' | 'CompanyCreated' | 'UserAdded' | 'UserRoleUpdated' | 'BrandingUpdated' | 'CompanyDeactivated' | 'LicensePoolCreated' | 'LicensesAdded' | 'LicenseConsumed' | 'LicenseReleased' | 'WarningThresholdUpdated';
...
export type DomainEvent = SessionCreatedEvent | SessionStartedEvent | ResponseRecordedEvent | PageCompletedEvent | SessionCompletedEvent | SessionExpiredEvent | SessionSuspendedEvent | ParticipantCreatedEvent | ParticipantProfileUpdatedEvent | ParticipantSessionAssignedEvent | ParticipantDeactivatedEvent | CompanyCreatedEvent | UserAddedEvent | UserRoleUpdatedEvent | BrandingUpdatedEvent | CompanyDeactivatedEvent | LicensePoolCreatedEvent | LicensesAddedEvent | LicenseConsumedEvent | LicenseReleasedEvent | WarningThresholdUpdatedEvent;
