    ...
    async generateReport(options) {
        ...
        options.categories.forEach((category) => {
            ...
            doc
                .fontSize(9)
                .fillColor('#666666')
                .text(`${category.score} / ${category.maxScore} points • ${category.questionsAnswered} questions`, 50, barY + 38);
            doc.moveDown(3);
        });
        // Footer
        doc
            .fontSize(8)
            .fillColor('#999999')
            .text(`Rapport généré le ${new Date().toLocaleDateString('fr-FR')} à ${new Date().toLocaleTimeString('fr-FR')}`, 50, doc.page.height - 50, { align: 'center' });
        doc
            .fontSize(8)
            .fillColor('#999999')
