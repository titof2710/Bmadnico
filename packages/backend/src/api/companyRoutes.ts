...
import { getEventStore, getCompanyProjectionStore } from '../infrastructure/database.js';
import { CompanyCommandHandler } from '../domain/CompanyCommandHandler.js';
...
router.get('/', async (req: Request, res: Response) => {
  try {
    const companyStore = getCompanyProjectionStore();
...
router.post('/', async (req: Request, res: Response) => {
  try {
    ...
    const commandHandler = new CompanyCommandHandler(eventStore);
 ...
 */
router.post('/:companyId/users', async (req: Request, res: Response) => {
  try {
    const { companyId } = req.params;
 ...
 * Update user role
 */
router.put('/:companyId/users/:userId/role', async (req: Request, res: Response) => {
  try {
 ...
 */
router.put('/:companyId/branding', async (req: Request, res: Response) => {
  try {
    const { companyId } = req.params;
