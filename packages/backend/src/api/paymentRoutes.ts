...
import { getProductProjectionStore, getLicensePoolProjectionStore } from '../infrastructure/database.js';
import { LicensePoolCommandHandler } from '../domain/LicensePoolCommandHandler.js';
import { getEventStore } from '../infrastructure/database.js';
...
router.post('/create-checkout-session', async (req: Request, res: Response) => {
  try {
    const organizationId = (req as any).organizationId || req.body.organizationId || 'demo-org-1';
